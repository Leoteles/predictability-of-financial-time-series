...
%Dados de 1998 a 2010
anoinicial = 1998;
anofinal = 2010;
for ano = anoinicial:anofinal
    histano = xlsread('IBOVDIA1998-2010.XLS',int2str(ano));
...
%ibov = hist;
ibov_1968_2010_ymd_c = hist;

semilogy(ibov_1968_2010_ymd_c(:,4))

save('ibov_1968_2010', 'ibov_1968_2010_ymd_c');