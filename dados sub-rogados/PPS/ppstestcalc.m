function ppstestcalc(n,datas,nolinear);

% function ppstestcalc(n,datas,nolinear);
%
% do surrogate calculations (all of them) as a function of the length of data n
% for financial data (show how these algorithms work for arch,
% garch and egarch data.
%
% optional datas=1:3
...
if 0,
  ...
  z=arch([1 0.5],20001);
  z=cumsum(z)+120;
  z=garch([1 0.1 0.8],20001);
  z=cumsum(z)+120;
  z=egarch([1 0.1 0.8 0.1],20001);
  z=cumsum(z)+120;
end;
